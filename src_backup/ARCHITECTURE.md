...
/features
/auth - pages, components, hooks relacionados a login/register
/perfil - componentes e páginas de perfil
/deck - páginas e componentes de Decks
/components - primitives e UI shared (Button, Input, Layout)
/hooks - hooks compartilhados (useAuth, useFetch)
/lib - clients (api.ts), utils, services
